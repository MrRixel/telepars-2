...
local function description_rules(msg, nama)
   ...
   if data[tostring(msg.to.id)] then
      ...
      if data[tostring(msg.to.id)]["description"] then
         ...
         about = "\nâ€؛ طھظˆط¶غŒط­ط§طھ ع¯ط±ظˆظ‡ :\n"..about.."\n"
      end
      if data[tostring(msg.to.id)]["rules"] then
         rules = data[tostring(msg.to.id)]["rules"]
         rules = "\nâ€؛ ظ‚ظˆط§ظ†غŒظ† ع¯ط±ظˆظ‡ :\n"..rules.."\n"
      end
       local sambutan = "ط³ظ„ط§ظ… "..nama.." ط¹ط²غŒط²\nط¨ظ‡ ع¯ط±ظˆظ‡ "..string.gsub(msg.to.print_name, "_", " ").."\nط®ظˆط´ ط¢ظ…ط¯غŒط¯ طŒ ط´ظ…ط§ ظ…غŒطھظˆط§ظ†غŒط¯ ط¨ظ‡ ع©ظ…ع©\nط¯ط³طھظˆط± /help ط±ط§ظ‡ظ†ظ…ط§غŒغŒ ط¯ط±غŒط§ظپطھ ع©ظ†غŒط¯.\n"
